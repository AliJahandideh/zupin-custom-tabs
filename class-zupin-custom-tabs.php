...
/**
 * Main Zupin Custom Tabs Class
 */
final class Zupin_CustomTabs {
	...
	public function i18n() {
		load_plugin_textdomain( 'zup-widgets' );
	}
	...
	public function init() {
		...
		function add_elementor_widget_categories( $elements_manager ) {
			...
			$elements_manager->add_category(
			  'zup-custom-tabs',
			  [
				'title' => __( 'Zupin Custom Tabs', 'zup-widgets' ),
				'icon' => 'fa fa-plug',
			  ]
			);
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ZUPIN_CUSTOMTABS ) );
...
// Instantiate Zupin_CustomTabs.
new Zupin_CustomTabs();
